...
import { FaArrowRightLong, FaCommentDollar } from "react-icons/fa6";
    ...
    <div className=" bg-white rounded-xl border shadow-xl">
      ...
      <div className="card pb-5 px-3">
        <p className="flex font-medium py-1 items-center"><IoLocationSharp/>{location}</p>
          ...
          <div className="text-end mt-2"><Link to={`/details/${_id}`}><button className="btn btn-sm btn-outline btn-success"><span className="flex items-center gap-1">View Details <FaArrowRightLong /></span></button></Link></div>
          </div>
